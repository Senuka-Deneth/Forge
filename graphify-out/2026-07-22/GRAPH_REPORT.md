...
## Corpus Check
- 133 files · ~147,094 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 999 nodes · 1960 edges · 68 communities (54 shown, 14 thin omitted)
...
6. `fetchBinanceKlines()` - 14 edges
7. `buildPivotDataFromHtf()` - 14 edges
8. `normalizeModelOutput()` - 14 edges
9. `JournalPanel()` - 13 edges
10. `calculateATR()` - 13 edges
...
Cohesion: 0.06
Nodes (54): ScoredRow, AlertRow, fetchLatestPrice(), TriggeredAlert, ALLOWED_INTERVALS, isCandleArray(), readMarketCache(), clamp() (+46 more)
...
Cohesion: 0.07
Nodes (36): AIAnalysisPanel(), colorMap, loadPositionCalcDefaults(), PositionSizeCalculator(), formatR(), pct(), VERDICT_STYLES, VerdictPanel() (+28 more)
...
Cohesion: 0.11
Nodes (31): buildContextFromCandles(), BuildContextOptions, buildLevelInputsFromContext(), buildUserMessage(), clamp(), compactConfluenceCluster(), compactForPrompt(), ConfluenceInputParts (+23 more)
...
Cohesion: 0.15
Nodes (16): barHitLong(), barHitShort(), defaultFractions(), entryFilled(), feeCostR(), LadderStepResult, ScoredOutcome, scorePlanAgainstCandles() (+8 more)
...
Cohesion: 0.05
Nodes (43): ALLOWED_INTERVALS, ANALYSIS_JSON_SCHEMA, ANALYSIS_REGIME_SET, AnalysisMarketRegime, AnalysisMeta, ANOMALY_TYPE_SET, AnomalyType, attachDecisionLayer() (+35 more)

### Community 59 - "crossMarket.ts"
Cohesion: 0.08
Nodes (42): AtrResult, OHLC, trueRangeSeries(), wilderSmooth(), alignClosesByTime(), buildCrossMarketContext(), computeDominance(), CrossMarketContext (+34 more)

### Community 60 - "calibration.ts"
Cohesion: 0.20
Nodes (13): fetchEmpiricalCalibration(), CalibrationBucket, CalibrationRow, computeBrierScore(), computeReliabilityCurve(), computeSetupStats(), confidenceDecile(), decidedCounts() (+5 more)
...
Cohesion: 0.09
Nodes (36): breakevenHitRate(), computeExpectancy(), entryMid(), ExpectancyResult, feeCostR(), finite(), wilsonInterval(), applyGuardrailVerdict() (+28 more)
...
- **Why does `ChartPanel()` connect `ChartPanel.jsx` to `main.jsx`, `pivotChartPrefs.js`, `volumeProfilePrimitive.js`, `chartIndicators.js`, `chartTheme.js`, `confluence.ts`?**
